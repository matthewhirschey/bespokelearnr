...
message("Data prepared. File saved in data directory. Now make some metadata.")
}
...
prepare_metadata <- function(bespoke_dataframe = NULL,
  ...
  if(is.null(bespoke_dataframe)){
    rstudioapi::documentNew(
      paste0("#set these variables (default is from mtcars dataset)",
             "\n",
...
# test <- paste0("#set these variables (default is from mtcars dataset)",
#                "\n",
#                "\ndataframe_file_name <-", "'",  'bespoke_dataframe', "' #don't change this variable",
#                "\ndataframe_name <-", "'", 'mtcars', "'",
#                "\ndataframe_title <-", "'", 'Base R mtcars Dataset', "'",
...
#                "\ndataframe_join_about <-", "'",  'A dataframe to practice joining', "'"
# )
# this was for testing the ability to write to and save an R script, rather than rstudioapi
